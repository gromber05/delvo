...
const settingsCopy = {
  es: {
    title: "Ajustes",
    subtitle: "Gestiona tu perfil, configuracion y conexiones externas.",
    defaultUser: "Usuario Delvo",
    personalInfo: "Informacion personal",
    securityPassword: "Seguridad y contrasena",
    ...
    deleteWarning: "Esta accion es irreversible. Se eliminaran todos tus datos permanentemente.",
    cancel: "Cancelar",
    deleting: "Eliminando...",
    ...
    passwordHint: "Tu contrasena debe tener al menos",
    characters: "8 caracteres",
    minCharacters: "Minimo 8 caracteres",
    ...
    currentPasswordRequired: "Introduce tu contrasena actual",
    passwordLengthError: "La nueva contrasena debe tener al menos 8 caracteres",
