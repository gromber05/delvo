  ...
  return (
    <div className={cn("flex flex-col items-center gap-6", className)} {...props}>
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-sm text-white/50">Motor de productividad</p>
      </div>
      ...
      <div className="w-full rounded-2xl border border-white/8 bg-[#1a1a22] p-7 shadow-2xl">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-white/30">O continuar con</span>
            <div className="h-px flex-1 bg-white/8" />
          </div>
